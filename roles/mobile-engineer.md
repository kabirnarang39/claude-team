...
Custom MCPs: Figma or mobile platform docs tools if configured by the user
...
4. Search platform docs with a configured search tool before using any SDK API
